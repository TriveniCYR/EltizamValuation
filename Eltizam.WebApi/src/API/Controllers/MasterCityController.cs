...
namespace Eltizam.WebApi.Controllers
{
    ...
    public class MasterCityController : ControllerBase
    {
        ...
        #region Constructor
        public MasterCityController(IConfiguration configuration, IResponseHandler<dynamic> ObjectResponse, IExceptionService exceptionService, IMasterCityService CityService)
        {
