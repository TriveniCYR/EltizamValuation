...
namespace Eltizam.WebApi.Controllers
{
	...
	public class TestMasterLocationController : ControllerBase
	{
		#region Properties
		...
		#region Constructor
		public TestMasterLocationController(IConfiguration configuration, IResponseHandler<dynamic> ObjectResponse, IStringLocalizer<Errors> stringLocalizerError, IExceptionService exceptionService, IMasterLocationService LocationService)
		{
