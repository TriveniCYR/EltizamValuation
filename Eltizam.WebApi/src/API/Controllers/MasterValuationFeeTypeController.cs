...
namespace Eltizam.WebApi.Controllers
{
    ...
    public class MasterValuationFeeTypeController : ControllerBase
    {
        ...
        #region Constructor
        public MasterValuationFeeTypeController(IConfiguration configuration, IResponseHandler<dynamic> ObjectResponse, IExceptionService exceptionService, IMasterValuationFeeTypeService ValuationFeeTypeService)
        {
        ...
        [HttpGet, Route("GetAllValuationFeeType")]
        public async Task<IActionResult> GetAllValuationFeeType()
        {
            try
            {
                var oRoleList = await _ValuationFeeTypeService.GetAllValuationFeeType();
                if (oRoleList != null)
