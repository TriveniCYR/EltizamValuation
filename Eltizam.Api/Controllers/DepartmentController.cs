...
namespace EltizamValuation.Api.Controllers
{
    ...
    public class DepartmentController : ControllerBase
    {
        ...
        #region Constructor
        public DepartmentController(IConfiguration configuration, IResponseHandler<dynamic> ObjectResponse, IStringLocalizer<Errors> stringLocalizerError, IExceptionService exceptionService, IDepartmentService DepartmentService)
        {
