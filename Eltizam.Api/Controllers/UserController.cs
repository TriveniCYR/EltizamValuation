...
namespace EmcureNPD.API.Controllers.Masters
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpGet, Route("GetTblUserById/{id}")]
        public async Task<IActionResult> GetTblUserById([FromRoute] int id)
        {
            try
            {
                var oUserEntity = await _UserService.GetTblUserById(id);
        ...
        [HttpPost]
        [Route("InsertUpdateTblUser")]
        public async Task<IActionResult> InsertUpdateTblUser(TblUserModel oUser)
        {
            try
            {
                DBOperation oResponse = await _UserService.AddUpdateUser(oUser);
