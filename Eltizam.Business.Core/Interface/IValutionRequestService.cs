...
namespace Eltizam.Business.Core.Interface
{
    ...
    {
        Task<DataTableResponseModel> GetAll(DataTableAjaxPostModel model, string? userName, string? clientName, string? propertyName, int requestStatusId, int resourceId, int propertyTypeId, int countryId, int stateId, int cityId, string fromDate, string toDate, string? valRef);
