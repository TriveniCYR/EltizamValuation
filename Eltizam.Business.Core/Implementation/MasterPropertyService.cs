...
namespace Eltizam.Business.Core.Implementation
{
    public class MasterPropertyService : IMasterPropertyService
    {
            ...
            else
            {
                if (masterproperty.PropertyDetail != null)
                {
                    ...
                    else
                    {
                        ...
                        objLocation.CreatedBy = objProperty.CreatedBy;
                    ...
                    foreach (var doc in masterproperty.AmenityList)
                    {
                        if (doc.Id > 0)
                        {
                            ...
                            if (objAmenity != null)
                            {
                                ...
                                objAmenity.ModifiedBy = objProperty.ModifiedBy;
                        ...
                        else
                        {
                            ...
                            objAmenity.AmenityId = doc.AmenityId;
                            objAmenity.IsActive = doc.IsActive;
                            objAmenity.CreatedBy = objProperty.CreatedBy;
        ...
        public async Task<List<MasterPropertyModel>> GetMasterPropertyByFiltersAsync(int PropertyTypeId, int SubPropertyTypeId, int OwnershipTypeId)
        {
            ...
            var res = _repository.GetAllAsync(x => (x.PropertyTypeId == PropertyTypeId || PropertyTypeId == 0)
                                  && (x.PropertySubTypeId == SubPropertyTypeId || SubPropertyTypeId == 0)
                                  && (x.OwnershipTypeId == OwnershipTypeId || OwnershipTypeId == 0)
                                  && x.IsActive == true)
                                .Result.ToList();
