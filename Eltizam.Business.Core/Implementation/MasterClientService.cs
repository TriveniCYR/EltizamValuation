    ...
    public class MasterClientService : IMasterClientService
    {
        ...
        public async Task<DBOperation> AddUpdateMasterClient(MasterClientModel master_ClientModel)
        {
            ...
            else
            {
                ...
                await _fileUploadService.UploadFilesAsync(objClient.Id, Enum.GetName(TableNameEnum.Master_Client), master_ClientModel.uploadDocument, master_ClientModel.CreatedBy);
