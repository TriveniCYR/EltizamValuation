using Eltizam.Business.Core.Interface;using Eltizam.Business.Core.ModelMapper;using Eltizam.Business.Models;using Eltizam.Data.DataAccess.Core.Repositories;using Eltizam.Data.DataAccess.Core.UnitOfWork;using Eltizam.Data.DataAccess.Entity;using Eltizam.Data.DataAccess.Helper;using Eltizam.Utility;using Eltizam.Utility.Enums;using Eltizam.Utility.Helpers;using Eltizam.Utility.Utility;using Microsoft.EntityFrameworkCore;using System.Data;using System.Data.SqlClient;using static Eltizam.Utility.Enums.GeneralEnum;namespace Eltizam.Business.Core.Implementation{    public class MasterUserService : IMasterUserService    {        private readonly IUnitOfWork _unitOfWork;        private readonly IMapperFactory _mapperFactory;
                    ...
                    if (entityUser.Qualifications.Count > 0)
                    {
                        ...
                        foreach (var qualify in entityUser.Qualifications)
                        {
                            ...
                            else
                            {
                                ...
                                objUserQualification.IsActive = 1;
        ...
        public async Task<List<MasterApproverLevelModel>> GetApproverLevelList()        {
            var lstStf = _mapperFactory.GetList<MasterValuationRequestApproverLevel, MasterApproverLevelModel>(_approverLevelRepository.GetAll().ToList());
