    ...
    var columnObject = [
        ...
        },
        {
            "data": "id", "name": "Action", "render": function (data, type, row, meta) {
                ...
                html += '<li><a title="View" href="/Client/ClientDetail?id=' + row.id + '"><img src="../assets/view.svg" alt="view" />View</a></li>';
                html += '<li><a title="Edit" href="/Client/ClientManage?id=' + row.id + '"><img src="../assets/edit.svg" alt="edit" />Edit</a></li>';
