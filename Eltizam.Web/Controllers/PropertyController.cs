...
namespace EltizamValuation.Web.Controllers
{
    public class PropertyController : Controller
    {
        ...
        public PropertyController(IConfiguration configuration, IStringLocalizer<Shared> stringLocalizerShared, IHelper helper)
        {
        ...
        [HttpPost]
        public IActionResult PropertyManage(int id, MasterUserModel masterUser)
        {
            try
            {
