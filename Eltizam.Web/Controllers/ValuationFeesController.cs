...
{
    public class ValuationFeesController : Controller
    {
        ...
        public ValuationFeesController(IConfiguration configuration, IStringLocalizer<Shared> stringLocalizerShared, IHelper helper)
        {
